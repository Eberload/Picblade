...
Picblade is closed-source software distributed under a Donationware model.
...
Software: Executables, components, associated files, and documentation of Picblade.
...
indicating the name “Picblade”, in the form and location the User deems appropriate, provided that it is reasonable within the context of use.
...
Picblade es un software de código cerrado distribuido bajo un modelo Donationware.
...
Software: Ejecutables, componentes, archivos asociados y documentación de Picblade.
...
indicando el nombre “Picblade”, en la forma y lugar que considere pertinente, siempre que ello sea razonable dentro del contexto de uso.
