...
<p align="justify">Move or resize an area: To move: place the cursor inside the selected area (the cursor will change to a cross) and drag. To resize: click on any of the visible handles and drag it.</p>
